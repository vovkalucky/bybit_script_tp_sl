from db.queries.orm import SyncCore, CoinsOrm, ListOfOpenDealsOrm, DealsOrm

SyncCore.create_tables()

#CoinsCore.delete_coin("BTCUSDT")
#CoinsCore.add_coin("ETHUSDT")
#ListOfOpenDealsOrm.delete_deal("235632321451541145")
# ListOfOpenDealsOrm.append_deal("BTC", "235632321451541145")
# ListOfOpenDealsOrm.append_deal("ETH", "235632321451541")
# ListOfOpenDealsOrm.append_deal("LTC", "23563232145")
# print(ListOfOpenDealsOrm.select_all_deals())
